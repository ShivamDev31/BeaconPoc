package com.shivamdev.beaconpoc.features.base;
...
import com.shivamdev.beaconpoc.BeaconApp;
import com.shivamdev.beaconpoc.injection.component.ConfigPersistentComponent;
import com.shivamdev.beaconpoc.injection.component.DaggerConfigPersistentComponent;
import com.shivamdev.beaconpoc.injection.component.FragmentComponent;
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent =
                    DaggerConfigPersistentComponent.builder()
                            .appComponent(BeaconApp.get(getActivity()).getComponent())
                            .build();
